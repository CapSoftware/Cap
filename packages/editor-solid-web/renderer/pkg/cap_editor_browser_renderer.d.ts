...
export class BrowserStudioRenderer {
   ...
   */
  static create(canvas: HTMLCanvasElement, prefer_webgpu: boolean, recording_meta_json: string, screen_width: number, screen_height: number, camera_width: number, camera_height: number): Promise<BrowserStudioRenderer>;
