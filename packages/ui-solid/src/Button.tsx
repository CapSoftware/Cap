...
const styles = cva(
	"outline-offset-2 outline-2 flex justify-center items-center focus-visible:outline-solid rounded-full transition-all will-change-transform duration-200",
	{
		defaultVariants: {
			variant: "primary",
			size: "md",
