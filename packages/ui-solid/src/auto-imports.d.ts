...
declare global {
  ...
  const IconLucideAlignLeft: typeof import('~icons/lucide/align-left.jsx')['default']
  const IconLucideAlignRight: typeof import('~icons/lucide/align-right.jsx')['default']
