    ...
    return (
      <input
        ...
        className={classNames(
          ...
          "rounded-xl hover:bg-gray-2 hover:border-gray-5 h-[48px] py-[14px] border-[1px] focus:border-gray-5",
          "file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-8",
