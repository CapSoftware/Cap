    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={classNames(
            "block p-3 space-y-1 leading-none no-underline rounded-md transition-all duration-200 outline-none select-none hover:bg-zinc-50 hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground",
            className
          )}
          {...props}
        >
