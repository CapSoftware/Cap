    ...
    >
      ...
      {isLoading === false && (
        <div
          ...
          } z-20 ${showReactionBar && "opacity-100"}`}
        >
          <button
      ...
      <div className="absolute top-0 z-20 w-full text-white bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-all">
        <div className="px-6 md:flex md:items-center md:justify-between space-x-0 md:space-x-6">
      ...
      {showReactionBar && (
        <div className="absolute bottom-0 transform -translate-y-16 z-20 w-full flex justify-center">
