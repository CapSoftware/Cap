...
export type RecordingMetaWithMetadata = ((StudioRecordingMeta | InstantRecordingMeta) & {
	platform?: Platform | null;
	pretty_name: string;
	sharing?: SharingMeta | null;
	upload?: UploadMeta | null;
...
export type UploadMeta =
	...
	| { state: "SinglePartUpload"; video_id: string; recording_dir: string; file_path: string; screenshot_path: string }
