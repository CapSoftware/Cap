...
export type PerspectiveAnimation = "none" | "zoomIn" | "zoomOut"
export type PerspectiveSegment = { start: number; end: number; preset?: PerspectiveViewPreset; animation?: PerspectiveAnimation; rotationX?: number; rotationY?: number; rotationZ?: number; fov?: number; zoom?: number; cameraDistance?: number }
export type PerspectiveViewPreset = "slantLeft" | "slantRight" | "topDown" | "bottomUp" | "isometricLeft" | "isometricRight" | "custom"
...
export type TimelineConfiguration = { segments: TimelineSegment[]; zoomSegments: ZoomSegment[]; sceneSegments?: SceneSegment[]; maskSegments?: MaskSegment[]; textSegments?: TextSegment[]; perspectiveSegments?: PerspectiveSegment[] }
