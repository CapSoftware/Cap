...
export type CaptionSettings = { enabled: boolean; font: string; size: number; color: string; backgroundColor: string; backgroundOpacity: number; position?: string; italic: boolean; fontWeight?: number; outline: boolean; outlineColor: string; exportWithSubtitles: boolean; highlightColor?: string; fadeDuration?: number; lingerDuration?: number; wordTransitionDuration?: number }
...
export type Layout3DSegment = { start: number; end: number; enabled?: boolean; rotationX?: number; rotationY?: number; depthZoom?: number; easing?: Layout3DEasing; fadeDuration?: number }
...
export type TimelineConfiguration = { segments: TimelineSegment[]; zoomSegments: ZoomSegment[]; sceneSegments?: SceneSegment[]; maskSegments?: MaskSegment[]; textSegments?: TextSegment[]; layout3DSegments?: Layout3DSegment[] }
