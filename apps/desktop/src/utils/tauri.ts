...
async getRecordingMeta(path: string, fileType: FileType) : Promise<RecordingMetaWithMode> {
...
export type HotkeyAction = "startStudioRecording" | "startInstantRecording" | "stopRecording" | "restartRecording"
...
export type RequestStartRecording = { mode: RecordingMode | null }
