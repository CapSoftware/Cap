...
export type UploadProbeStatus = "Healthy" | "Degraded" | "Failed"
export type RecordingEvent = { variant: "Countdown"; value: number } | { variant: "Started" } | { variant: "Stopped" } | { variant: "Paused" } | { variant: "Resumed" } | { variant: "Failed"; error: string } | { variant: "InputLost"; input: RecordingInputKind } | { variant: "InputRestored"; input: RecordingInputKind } | { variant: "Degraded"; reason: string } | { variant: "Recovered" } | { variant: "UploadProbe"; status: UploadProbeStatus; upload_mbps: number | null; recommended_max_resolution: number; applied_max_resolution: number; detail: string }
