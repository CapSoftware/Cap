...
export type ExportConfiguration = { format: ExportFormat; gifQuality: GifQuality; gifFps: number }
export type ExportEstimates = { duration_seconds: number; estimated_time_seconds: number; estimated_size_mb: number }
export type ExportFormat = "mp4" | "gif"
export type Flags = { recordMouseState: boolean; split: boolean; timelineZooming: boolean }
...
export type GifQuality = "standard" | "high"
...
export type ProjectConfiguration = { aspectRatio: AspectRatio | null; background: BackgroundConfiguration; camera: Camera; audio: AudioConfiguration; cursor: CursorConfiguration; hotkeys: HotkeysConfiguration; timeline?: TimelineConfiguration | null; motionBlur: number | null; export?: ExportConfiguration }
