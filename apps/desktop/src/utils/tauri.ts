...
export type UploadMeta = { state: "MultipartUpload"; video_id: string } | { state: "SinglePartUpload"; video_id: string; file_path: string; screenshot_path: string } | { state: "Failed"; error: string } | { state: "Complete" }
