...
export const commands = {
  async getRecordingOptions(): Promise<Result<RecordingOptions, null>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_recording_options"),
      };
    } catch (e) {
  ...
  async setRecordingOptions(
    options: RecordingOptions
  ): Promise<Result<null, null>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_recording_options", { options }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setFakeWindowBounds(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_fake_window_bounds", { name, bounds }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async removeFakeWindow(name: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_fake_window", { name }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCurrentRecording(): Promise<
    Result<JsonValue<InProgressRecording | null>, null>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_current_recording"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async renderToFile(
    ...
    progressChannel: TAURI_CHANNEL<RenderProgress>
  ): Promise<void> {
    await TAURI_INVOKE("render_to_file", {
      outputPath,
      videoId,
      project,
      progressChannel,
  ...
  async getRenderedVideo(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_rendered_video", { videoId, project }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async copyFileToPath(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("copy_file_to_path", { src, dst }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async copyRenderedVideoToClipboard(
    videoId: string,
    project: ProjectConfiguration
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("copy_rendered_video_to_clipboard", {
          videoId,
          project,
        }),
      };
  ...
  async copyScreenshotToClipboard(path: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("copy_screenshot_to_clipboard", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async openFilePath(path: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("open_file_path", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getVideoMetadata(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_video_metadata", { videoId, videoType }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createEditorInstance(
    videoId: string
  ): Promise<Result<SerializedEditorInstance, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_editor_instance", { videoId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async uploadRenderedVideo(
    videoId: string,
    project: ProjectConfiguration,
    preCreatedVideo: PreCreatedVideo | null
  ): Promise<Result<UploadResult, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("upload_rendered_video", {
          videoId,
          project,
          preCreatedVideo,
        }),
  ...
  async uploadScreenshot(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("upload_screenshot", { screenshotPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async saveFileDialog(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("save_file_dialog", { fileName, fileType }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listRecordings(): Promise<
    Result<[string, string, RecordingMeta][], string>
  > {
    try {
  ...
  async checkUpgradedAndUpdate(): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("check_upgraded_and_update"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async openExternalLink(url: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("open_external_link", { url }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setHotkey(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_hotkey", { action, hotkey }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setGeneralSettings(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_general_settings", { settings }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteAuthOpenSignin(): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("delete_auth_open_signin"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async resetCameraPermissions(): Promise<Result<null, null>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("reset_camera_permissions"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async resetMicrophonePermissions(): Promise<Result<null, null>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("reset_microphone_permissions"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type GeneralSettingsStore = {
  upload_individual_files: boolean;
  open_editor_after_recording: boolean;
  hide_dock_icon?: boolean;
  auto_create_shareable_link?: boolean;
...
export type InProgressRecording = {
  recordingDir: string;
  displaySource: ScreenCaptureTarget;
  segments: number[];
};
