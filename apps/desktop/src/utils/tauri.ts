...
async exportVideo(projectPath: string, progress: TAURI_CHANNEL<FramesRendered>, settings: ExportSettings, format: ExportFormat) : Promise<string> {
    return await TAURI_INVOKE("export_video", { projectPath, progress, settings, format });
},
