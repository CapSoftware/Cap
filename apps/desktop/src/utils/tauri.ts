...
export type BlurSegment = { start: number; end: number; blur_amount: number | null; rect: Rect }
...
export type TimelineConfiguration = { segments: TimelineSegment[]; zoomSegments: ZoomSegment[]; blurSegments: BlurSegment[] | null }
