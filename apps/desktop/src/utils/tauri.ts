...
export type UploadDebugEvent = { video_id: string; upload_id: string; state: UploadDebugEventState }
export type UploadDebugEventState = "Pending" | { Uploading: { part_number: number; chunk_size: string; total_size: string; duration: string } } | "Done"
