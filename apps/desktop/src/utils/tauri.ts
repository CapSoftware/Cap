...
export type CompressionConfig = { enabled: boolean; quality: CompressionQuality; preset: CompressionPreset; audioBitrate: number; deleteOriginal: boolean }
export type CompressionPreset = "slow" | "medium" | "fast"
