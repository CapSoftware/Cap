...
export const DEVICE_SHORTCUT_BUTTON_CLASS =
	"flex size-7 items-center justify-center rounded-md text-gray-10 hover:text-gray-12 hover:bg-gray-5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-1 focus-visible:ring-offset-gray-1";
