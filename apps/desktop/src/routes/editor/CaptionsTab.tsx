...
export function CaptionsTab() {
  ...
  createEffect(() => {
    ...
    if (JSON.stringify(settings) !== JSON.stringify(project.captions.settings)) {
      batch(() => {
        ...
        events.renderFrameEvent.emit({
          frame_number: Math.floor(playbackTime() * FPS),
          fps: FPS,
                    ...
                    <Show when={captionSettings.outline}>
                      <div class="flex flex-col gap-2">
                        ...
                        <RgbInput
                          ...
                          onChange={(value) => updateCaptionSetting("outlineColor", value)}
                        />
                      </div>
                    </Show>
                  </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-100 border border-gray-200 rounded-lg p-4 space-y-4">
                              <div class="flex flex-col space-y-4">
                                <div class="flex space-x-4">
                                  <div class="flex-1">
                                    <label class="text-xs text-gray-400 dark:text-gray-500">Start Time</label>
                                    <Input
                                      type="number"
                                      class="w-full"
                                  ...
                                  <div class="flex-1">
                                    <label class="text-xs text-gray-400 dark:text-gray-500">End Time</label>
                                    <Input
                                      type="number"
                                      class="w-full"
                                ...
                                <div class="space-y-2">
                                  <label class="text-xs text-gray-400 dark:text-gray-500">Caption Text</label>
...
function IconDelete() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-4">
