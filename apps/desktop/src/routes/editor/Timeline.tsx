...
export function Timeline() {
  ...
  return (
    ...
    >
      <div
        class="py-[2rem] relative overflow-hidden bg-white dark:bg-zinc-100"
        style={{
      ...
      >
        ...
        <Show when={!playing() && previewTime()}>
          {(time) => (
            <div
              class={cx(
                "flex absolute bottom-0 top-4 left-5 z-10 justify-center items-center w-px pointer-events-none",
        ...
        {(segment, i) => {
          ...
          return (
            ...
            >
              ...
              />
              <SegmentContent class="justify-between bg-blue-50">
  ...
  return (
    <SegmentContextProvider width={width}>
      ...
      >
        <div
          class={cx(
            "h-full ring-1 flex flex-row rounded-xl overflow-hidden group",
            props.innerClass
          )}
        >
          {props.children}
