...
function Inner() {
  ...
  return (
    <div class="flex flex-col w-screen h-screen">
      <Header />
      <div
        class="flex overflow-y-hidden flex-col flex-1 gap-4 p-5 pt-0 w-full leading-5 bg-gray-50 animate-in fade-in"
        data-tauri-drag-region
      >
        <div class="flex overflow-hidden flex-col flex-1 mt-5 rounded-2xl border divide-y shadow border-zinc-200">
          <div class="flex overflow-y-hidden flex-row flex-1 divide-x">
            <Player />
            <ConfigSidebar />
          </div>
          <Timeline />
