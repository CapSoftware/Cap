...
import { openLinkInBrowser, openSettingsWindow } from "@/utils/helpers";
        ...
        <div className='flex space-x-2'>
          <div>
            <button
              ...
              className={`bg-red-500 hover:bg-red-700 transition-all ${actionButtonBase}`}></button>
          </div>
          <div>
            <button
              onClick={async () => {
              ...
              className={`bg-orange-400 hover:bg-orange-500 transition-all ${actionButtonBase}`}></button>
          </div>
          <div>
