...
use cap_desktop_runtime::{
    AppHandle, CommandContext, Manager, Window,
...
impl CommandArg for WindowScreenshotEditorInstance {
    fn from_command(context: &CommandContext) -> Result<Self, InvokeError> {
