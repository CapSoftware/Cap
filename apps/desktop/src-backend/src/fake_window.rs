...
pub async fn set_fake_window_bounds(
    ...
    state: cap_desktop_runtime::State<'_, FakeWindowBounds>,
) -> Result<(), String> {
...
fn should_ignore_cursor_events(
    window_position: cap_desktop_runtime::PhysicalPosition<i32>,
    mouse_position: cap_desktop_runtime::PhysicalPosition<f64>,
    scale_factor: f64,
...
fn recording_controls_size_allows_default_interaction(
    window_size: cap_desktop_runtime::PhysicalSize<u32>,
    scale_factor: f64,
) -> bool {
...
fn prepare_recording_controls_default_interaction(window: &WebviewWindow) -> bool {
    ...
    let _ = window.set_size(cap_desktop_runtime::LogicalSize::new(
...
mod tests {
    ...
    fn recording_controls_without_bounds_are_interactive() {
        assert!(!should_ignore_cursor_events(
            cap_desktop_runtime::PhysicalPosition::new(100, 200),
            cap_desktop_runtime::PhysicalPosition::new(150.0, 240.0),
            2.0,
            &HashMap::new(),
            false,
            true,
    ...
    fn recording_controls_without_bounds_pass_through_when_window_is_large() {
        assert!(should_ignore_cursor_events(
            cap_desktop_runtime::PhysicalPosition::new(0, 0),
            cap_desktop_runtime::PhysicalPosition::new(150.0, 240.0),
            2.0,
            &HashMap::new(),
            false,
    ...
    fn cursor_inside_registered_bounds_is_interactive() {
        ...
        assert!(!should_ignore_cursor_events(
            cap_desktop_runtime::PhysicalPosition::new(100, 200),
            cap_desktop_runtime::PhysicalPosition::new(150.0, 250.0),
            2.0,
            &windows,
            false,
            true,
    ...
    fn cursor_outside_registered_bounds_passes_through() {
        ...
        assert!(should_ignore_cursor_events(
            cap_desktop_runtime::PhysicalPosition::new(100, 200),
            cap_desktop_runtime::PhysicalPosition::new(50.0, 250.0),
            2.0,
            &windows,
            false,
            true,
    ...
    fn recording_controls_default_interaction_is_size_limited() {
        assert!(recording_controls_size_allows_default_interaction(
            cap_desktop_runtime::PhysicalSize::new(640, 300),
            2.0,
        ));
        assert!(!recording_controls_size_allows_default_interaction(
            cap_desktop_runtime::PhysicalSize::new(1920, 1080),
            2.0,
        ));
    }
