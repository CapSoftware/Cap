use cap_desktop_runtime::{AppHandle, CommandContext, Listener, Manager, Window, ipc::CommandArg};
...
pub struct EditorInstance {
    ...
    render_frame_event_id: cap_desktop_runtime::EventId,
}
...
impl CommandArg for WindowEditorInstance {
    fn from_command(
        context: &CommandContext,
    ) -> Result<Self, cap_desktop_runtime::ipc::InvokeError> {
...
impl CommandArg for OptionalWindowEditorInstance {
    fn from_command(
        context: &CommandContext,
    ) -> Result<Self, cap_desktop_runtime::ipc::InvokeError> {
        let window = context.window();
