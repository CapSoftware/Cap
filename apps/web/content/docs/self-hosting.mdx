...
Cap Web is our web application for uploading and sharing Caps.
It can be used on its own or be connected to Cap Desktop.
...
If you encounter a problem with the Docker image, or think this documentation is lacking, please [open an issue](https://github.com/CapSoftware/Cap/issues/new).
