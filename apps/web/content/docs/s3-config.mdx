...
>
> **Note**: While this guide focuses on AWS S3, Cap supports any S3-compatible storage service (like MinIO, DigitalOcean Spaces, or Backblaze B2). The setup process is similar - you'll just need the appropriate endpoint URL and credentials from your provider.
