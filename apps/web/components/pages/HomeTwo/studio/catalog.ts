...
const visual = (load: () => Promise<{ Visual: StudioCard["Visual"] }>) =>
	dynamic(() => load().then((module) => module.Visual));
...
export const CARDS_A: StudioCard[] = [
	{
		...
		Visual: visual(() => import("./cards/mask")),
	},
	{
		key: "scenes",
		...
		Visual: visual(() => import("./cards/scenes")),
	},
	{
		key: "text",
		...
		Visual: visual(() => import("./cards/text")),
	},
	{
		key: "zoom",
		...
		Visual: visual(() => import("./cards/zoom")),
	},
	{
		key: "captions",
		...
		Visual: visual(() => import("./cards/captions")),
	},
];
...
export const CARDS_B: StudioCard[] = [
	...
	},
	{
		...
		Visual: visual(() => import("./cards/clips")),
	},
];
