...
export const employeeOnboardingPlatformContent = {
...
const createFaqStructuredData = () => {
  const faqStructuredData = {
    ...
    "@type": "FAQPage",
    mainEntity: employeeOnboardingPlatformContent.faqs.map((faq) => ({
      "@type": "Question",
      name: faq.question,
      acceptedAnswer: {
        "@type": "Answer",
...
export const EmployeeOnboardingPlatformPage = () => {
  return (
    <>
      ...
      />
      <SeoPageTemplate content={employeeOnboardingPlatformContent} />
    </>
  );
};
