...
export const metadata: Metadata = {
	title: "Video",
	description: "Record, edit, and share videos.",
	openGraph: {
		title: "Video",
		description: "Record, edit, and share videos.",
		type: "website",
		url: buildEnv.NEXT_PUBLIC_WEB_URL,
		images: [`${buildEnv.NEXT_PUBLIC_WEB_URL}/og.png`],
	},
};
			...
			<html className={defaultFont.className} lang="en">
				<head>
					<link
						...
						sizes="180x180"
						href="/apple-touch-icon.png?v=shashank-face-2"
					/>
					<link
						rel="icon"
						type="image/png"
						sizes="32x32"
						href="/favicon-32x32.png?v=shashank-face-2"
					/>
					<link
						rel="icon"
						type="image/png"
						sizes="16x16"
						href="/favicon-16x16.png?v=shashank-face-2"
					/>
					<link rel="manifest" href="/site.webmanifest?v=shashank-face-2" />
					<link
						rel="mask-icon"
						href="/safari-pinned-tab.svg?v=shashank-face-2"
						color="#111111"
					/>
					<link rel="shortcut icon" href="/favicon.ico?v=shashank-face-2" />
