...
const SubscribeContent = () => {
  ...
  return (
          <div className="flex absolute z-10 flex-col gap-3 justify-center items-center w-full h-full backdrop-blur-md">
            ...
            className="text-lg text-center text-gray-12">This feature requires Cap Pro</motion.p>
               <motion.p
            initial={{ y: -10, filter: "blur(5px)", opacity: 0 }}
            animate={{ y: 0, filter: "blur(0px)", opacity: 1}}
            transition={{ duration: 0.3, ease: "easeOut", delay: 0.3 }}
            className="text-sm text-center text-gray-11">your domain could look like this</motion.p>
            </div>
        ...
        style={{
          background: 'linear-gradient(322deg,rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 19%, rgba(199, 199, 199, 1) 29%, rgba(217, 217, 217, 1) 52%, rgba(255, 255, 255, 1) 62%, rgba(158, 158, 158, 1) 83%, rgba(163, 163, 163, 1) 93%)',
        }}
      >
