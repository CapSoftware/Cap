                            ...
                            <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        <Skeleton className="h-[16px] w-[120px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[14px] w-[260px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Skeleton className="h-[44px] w-full rounded-xl" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[40px] w-[70px] rounded-full" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        <Skeleton className="h-[16px] w-[140px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[14px] w-[300px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Skeleton className="h-[44px] w-full rounded-xl" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[40px] w-[80px] rounded-full" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        <Skeleton className="h-[16px] w-[160px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[14px] w-[360px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Skeleton className="h-[44px] w-full rounded-xl" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[40px] w-[70px] rounded-full" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        <Skeleton className="h-[16px] w-[150px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        <Skeleton className="h-[14px] w-[320px]" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                    <div className="flex items-center justify-between p-3 rounded-xl border border-dashed border-gray-5">
                                        <div className="flex items-center gap-2">
                                            <Skeleton className="h-[28px] w-[110px] rounded-full" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                        </div>
                                        <Skeleton className="h-[28px] w-[28px] rounded-md" baseColor="var(--gray-4)" highlightColor="var(--gray-5)" />
                                    </div>
                                </div>
                            </div>
                        </div>
