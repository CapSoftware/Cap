...
interface UploadingContextType {
	...
	doUpload: (
		...
		// TODO: I wonder if we can do this better.
		// This is designed to ensure the old code is compatible.
		options?: DoUploadOptions,
	) => Promise<void>;
}
						...
						await new Promise<void>((resolve, reject) => {
							...
							xhr.onload = () => {
								if (xhr.status >= 200 && xhr.status < 300) {
									...
									// sendProgressUpdate(uploadId, 100, 100); // TODO
									resolve();
								} else {
