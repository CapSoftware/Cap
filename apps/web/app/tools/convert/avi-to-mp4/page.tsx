    ...
    faqs: [
      {
        ...
        answer:
          "Our converter uses WebAssembly to run FFmpeg directly in your browser. When you upload an AVI file, it gets processed locally on your device and converted to MP4 format without ever being sent to a server.",
      },
      {
