...
export function EditRecovery({ videoId }: { videoId: Video.VideoId }) {
		...
		<main className="flex min-h-screen items-center justify-center bg-gray-2 p-6">
			<div className="w-full max-w-md space-y-4 rounded-xl border border-gray-5 bg-gray-1 p-6">
				...
				<p className="text-sm text-gray-11">
					If this edit could not finish, you can restore the original recording.
					Your original source is preserved.
				</p>
				{error ? (
