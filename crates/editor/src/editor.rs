...
use cap_rendering::{
    decoder::DecodedFrame, DecodedSegmentFrames, FrameRenderer, ProjectRecordingsMeta, ProjectUniforms,
...
impl Renderer {
    pub fn spawn(
        ...
        let recordings = Arc::new(ProjectRecordingsMeta::new(&recording_meta.project_path, meta)?);
